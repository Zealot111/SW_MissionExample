...
if (count _w != count _a ) exitWith {WARNING("Количество весов не сопадает количеству элементов, используем простую случайную выборку!");[_a] call bis_fnc_selectrandom};
